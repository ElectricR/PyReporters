...
def get_news():
    ...
    ret_vals = [
        ...
        {'title': 'Daily coronavirus spread report',
            'text': f'Total number of infected with Covid-19 has increaed by {(100 * new_cases / (total_cases - new_cases)):.2f}% today!'},
        {'title': f'Total coronavirus cases as at {total_cases}!',
            'text': f'{total_cases} people got infected with Covid-19 from the beginning of pandemic!'}
    ]
